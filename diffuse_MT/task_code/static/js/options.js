...
var Option = function(stage, id, n_options) {
	...
	switch (n_options) {
		case 1:
			self.x = 350 //self.stage_w/2;
			self.y = 420 //30 + self.stage_h/4;
			break;
		case 2:
			self.x = 780 //220 + (self.stage_w-140)/2 * self.col;
			self.y = 420 //30 + self.stage_h/4;
			break;
		case 3:
			self.x = 350 //220 + (self.stage_w-140)/2 * self.col;
			self.y = 620 //30 + self.stage_h/4;
			break;
		case 4:
			self.x = 780 //220 + (self.stage_w-140)/2 * self.col;
			self.y = 620 //30 + self.stage_h/4;
	...
	self.draw = function() {
		self.obj = self.disp.append('image')
							...
							.attr('width', 200)
							.attr('height', 200)
							.attr('xlink:href', 'static/images/not_chosen.jpg'); // CHANGE THIS  BACK
